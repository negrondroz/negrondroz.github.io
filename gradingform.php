...
<html lang="en">
  ...
  <body>
    ...
    <h1>Grading Form</h1>
      <div class="row">
      <div id="gradeForm" name="gradeForm" class="form-inline" method="POST" action="<?= $_SERVER['PHP_SELF']; ?>">
            ...
            <div id="radioButtons" >
              <table class="table table-hover">
                <tr>
                  ...
                  <th class="text-center" colspan="3">Neutral</th>
                  <th class="text-center" colspan="3">+</th><th></th>
                </tr>
                <tr>
        ...
        <input id="submitButton" class="btn btn-primary btn-lg btn-block" type="submit" name="submit" value="Enter">

          <!-- Optional JavaScript
          <div id="results" class="col-md-1 text-center jumbotron">
